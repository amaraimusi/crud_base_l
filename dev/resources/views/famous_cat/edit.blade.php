...
<head>
	...
	<script src="{{ asset('/js/FamousCat/edit.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/FamousCat/edit.css')  . $ver_str}}" rel="stylesheet">
	
	<title>有名猫管理・編集フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">有名猫管理・編集フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form id="form1" method="POST" action="{{ url('famous_cat/update') }}" enctype="multipart/form-data">
			@csrf
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="neko_name" type="text"  class="form-control form-control-lg" placeholder="neko_name" value="{{old('neko_name', $ent->neko_name)}}" required  title="neko_nameを入力してください。">
				</div>
			</div>
