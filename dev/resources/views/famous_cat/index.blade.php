...
<head>
	...
	<script src="{{ asset('/js/FamousCat/index.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/FamousCat/index.css')  . $ver_str}}" rel="stylesheet">
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">有名猫管理画面(見本版)</li>
  </ol>
</nav>
...
<!-- 検索フォーム -->
<form method="GET" action="famous_cat">
		
	<div><?php echo $cbh->searchFormText('main_search', '検索', ['title'=>'有名猫名、備考を部分検索します']); ?></div>
	...
	<div style="display:inline-block;">
		<div id="search_dtl_div" style="display:none;">
			...
			<!-- CBBXS-6030 -->
			<div><?php echo $cbh->searchFormIntRange('neko_val', 'neko_val'); ?></div>
			<div><?php echo $cbh->searchFormText('neko_name', 'neko_name'); ?></div>
			<div><?php echo $cbh->searchFormDateRng('neko_date', 'neko_date'); ?></div>
			<div><?php echo $cbh->searchFormSelect('neko_type', '猫種別', $nekoTypeList); ?></div>
			<div><?php echo $cbh->searchFormDatetime('neko_dt', 'neko_dt'); ?></div>
...
<div style="margin-top:0.4em;">
	...
	<div class="tool_btn_w">
		<a href="famous_cat/csv_download" class="btn btn-secondary">CSV</a>
	</div>
...
<table id="main_tbl" class="table table-striped table-bordered table-condensed">
	<thead>
		<tr>
			<th data-field='id'><?php echo $cbh->sortLink($searches, 'famous_cat', 'id', 'ID'); ?></th>
			<!-- CBBXS-6035 -->
			<th data-field='neko_val'><?php echo $cbh->sortLink($searches, 'famous_cat', 'neko_val', 'neko_val'); ?></th>
			<th data-field='neko_name'><?php echo $cbh->sortLink($searches, 'famous_cat', 'neko_name', 'neko_name'); ?></th>
			<th data-field='neko_date'><?php echo $cbh->sortLink($searches, 'famous_cat', 'neko_date', 'neko_date'); ?></th>
			<th data-field='neko_type'><?php echo $cbh->sortLink($searches, 'famous_cat', 'neko_type', '猫種別'); ?></th>
			<th data-field='neko_dt'><?php echo $cbh->sortLink($searches, 'famous_cat', 'neko_dt', 'neko_dt'); ?></th>
			<th data-field='neko_flg'><?php echo $cbh->sortLink($searches, 'famous_cat', 'neko_flg', 'ネコフラグ'); ?></th>
			<th data-field='img_fn'><?php echo $cbh->sortLink($searches, 'famous_cat', 'img_fn', '画像ファイル名'); ?></th>
			<th data-field='note'><?php echo $cbh->sortLink($searches, 'famous_cat', 'note', '備考'); ?></th>

			<!-- CBBXE -->
			<th data-field='sort_no'><?php echo $cbh->sortLink($searches, 'famous_cat', 'sort_no', '順番'); ?></th>
			<th data-field='delete_flg'><?php echo $cbh->sortLink($searches, 'famous_cat', 'delete_flg', '無効フラグ'); ?></th>
			<th data-field='update_user_id'><?php echo $cbh->sortLink($searches, 'famous_cat', 'update_user_id', '更新者'); ?></th>
			<th data-field='ip_addr'><?php echo $cbh->sortLink($searches, 'famous_cat', 'ip_addr', 'IPアドレス'); ?></th>
			<th data-field='created_at'><?php echo $cbh->sortLink($searches, 'famous_cat', 'created_at', '生成日時'); ?></th>
			<th data-field='updated_at'><?php echo $cbh->sortLink($searches, 'famous_cat', 'updated_at', '更新日'); ?></th>
