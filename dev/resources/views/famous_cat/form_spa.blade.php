...
<div style="max-width:840px;margin: auto;">
	...
	<!-- CBBXS-6007 -->
	<div class="row mt-2">
		<div class='col-md-2 ' >neko_val</div>
		<div class='col-md-10'>
			<input type="text" name="neko_val" class="form-control form-control-lg " value=""  maxlength="11"  required title="neko_valは11文字以内で入力してください" />
			<span class="text-danger" data-valid-err='neko_val'></span>
		</div>
	</div>

	<div class="row mt-2">
		<div class='col-md-2 ' >neko_name</div>
		<div class='col-md-10'>
			<input type="text" name="neko_name" class="form-control form-control-lg " value=""  maxlength="255"  required title="neko_nameは255文字以内で入力してください" />
			<span class="text-danger" data-valid-err='neko_name'></span>
		</div>
	</div>

	<div class="row mt-2">
		<div class='col-md-2' >neko_date</div>
		<div class='col-md-10'>
			<!-- datetime-local要素はpattern属性を指定できないので注意。強制的にバリデーションが発動してまう。秒単位の入力にするにはstep="1"を追記 -->
			<input type="date" name="neko_date" class="form-control form-control-lg " value="" step="1" title="日時形式（Y-m-d H:i:s）で入力してください(例：2012-12-12 01:02:03)" />
			<span class="text-danger" data-valid-err="neko_date" ></span>
		</div>
	</div>
	
	<div class="row mt-2">
		<div class='col-md-2' >猫種別 </div>
		<div class='col-md-10'>
	...
	<div class="row mt-2">
		<div class='col-md-2' >neko_dt</div>
		<div class='col-md-10'>
			<!-- datetime-local要素はpattern属性を指定できないので注意。強制的にバリデーションが発動してまう。秒単位の入力にするにはstep="1"を追記 -->
