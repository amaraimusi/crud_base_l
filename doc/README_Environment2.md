...
```
git clone git@github.com:amaraimusi/crud_base_l.git
```
...
⑦ MySQLにてcrud_base_lデータベースを作成してください。照合順序はutf8mb4_general_ciを選択してください。

```
例
CREATE DATABASE crud_base_l COLLATE utf8mb4_general_ci
```

⑧ crud_base_l.sqlダンプファイル(crud_base_l/doc/crud_base_l.sql)をインポートしてください。
...
```
例
http://localhost/crud_base_l/dev/public/
```
